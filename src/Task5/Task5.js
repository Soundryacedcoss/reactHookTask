...
export const Task5 = () => {
  ...
  const SelectHandler = (e) => {
    setSelectItem(parseInt(e.target.value));
  };
  // setInput(parseInt(input))
  // setSelectItem(parseInt(selectItem))
  ...
  return (
    <div>
      <h2>Task 5</h2>
      <b>
        Q5. Make the currency converter you made using context, now with
        useContext Hook
      </b>
      <br />
      <inputContext.Provider value={{ input, setInput }}>
        <SelectContext.Provider value={{ selectItem, setSelectItem }}>
          <div className="flex">
            <input
              type="number"
